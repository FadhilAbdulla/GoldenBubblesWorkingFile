...
import { BsGeoAlt, BsHeadset, BsBuilding } from 'react-icons/bs'
        ...
        <Row className="justify-content-between">
          <Col lg={6} className="mb-6 mb-lg-0 =">
            <div className="d-flex flex-column h-100 justify-content-center">
              ...
              <p className="mb-4">
                Our team is here to help you succeed. Reach out anytime at <Link href="mailto:support@goldenbubbles.com">{config.email}</Link> or use
                the form to get a quick response from our experts.
              </p>
              <ul className="list-group list-group-borderless border-0">
                <li className="d-flex mb-3 align-items-center">
                  <BsBuilding className="text-primary me-2" />
                  Golden bubbles Investments L.L.C-FZ
                </li>
              ...
              {/* <div className="d-sm-flex gap-3 align-items-center my-5">
                <h6 className="mb-3 mb-sm-0">Follow us:</h6>
                <ul className="list-inline flex-wrap mb-0 d-flex gap-1">
                  {followUsIcons.map((item, idx) => {
                    const Icon = item.icon
                    return (
                      <li className="list-inline-item" key={idx}>
                        <Link href={item.link || '#'} className={`btn btn-icon btn-light rounded-circle ${item.variant}`}>
                          <Icon />
                        </Link>
                      </li>
                    )
