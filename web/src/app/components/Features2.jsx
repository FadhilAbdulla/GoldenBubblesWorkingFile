...
import portfolioImg from '@//assets/images/bg/NavImg.png'
import { Card, Col, Container, Row } from 'react-bootstrap'
import { FaFacebookF, FaInstagram, FaTwitter, FaLinkedinIn, FaYoutube } from 'react-icons/fa6'
import { BsDiagram3, BsBoxes, BsPeople, BsShieldCheck, BsGlobe2, BsLightningCharge, BsPhone } from 'react-icons/bs'
      ...
      <Container>
        <Row className="g-4">
          <Col lg={6} className="mb-sm-6 mb-lg-0">
            <h2 className="mb-4">Your All-in-One Trading Platform</h2>
            <p className="mb-0">
              Experience seamless trading with our platform, designed for every trader. Access global markets, enjoy a powerful interface, and get
            ...
            <Row className="g-4 mb-4 mb-sm-5">
              <Col sm={6}>
                <div className="d-flex mb-4 mb-sm-5">
                  <div className="icon-md flex-shrink-0 text-primary bg-primary bg-opacity-10 rounded-circle">
                    <BsGlobe2 size={19} className="fa-xl" />
                  </div>
                  <div className="ms-3">
                    <h6 className="mb-0 mb-sm-2">Access Multiple Markets</h6>
                    <p className="mb-0">Trade forex, metals, shares, indices, and commodities—all in one place.</p>
                  </div>
                </div>
                <div className="d-flex ">
                  ...
                  <div className="ms-3">
                    <h6 className="mb-0 mb-sm-2">Trade Anywhere</h6>
                    <p className="mb-0">Mobile and desktop access for trading on your terms.</p>
                  </div>
                </div>
              </Col>
              ...
              <Col sm={6}>
                <div className="d-flex mb-4 mb-sm-5">
                  <div className="icon-md flex-shrink-0 text-primary bg-primary bg-opacity-10 rounded-circle">
                    <BsLightningCharge size={19} className="fa-xl" />
                  </div>
                  <div className="ms-3">
                    <h6 className="mb-0 mb-sm-2">Intuitive Trading Interface</h6>
                    <p className="mb-0">Enjoy a fast, user-friendly platform built for efficiency and clarity.</p>
                  </div>
                </div>
                ...
                <div className="d-flex">
                  ...
                  <div className="ms-3">
                    <h6 className="mb-0 mb-sm-2">24/7 Support</h6>
                    <p className="mb-0">Our team is always here to help, day or night.</p>
                  </div>
                </div>
              </Col>
            </Row>
            ...
            <Row>
              <Col lg={11} xl={9} className="position-relative ms-auto">
                ...
                <Card className="border p-4">
                  <Image src={portfolioImg} className="card-img mb-3" alt="Platform screenshot" />

                  <h6 className="mb-2">Trade Smarter, Trade Faster</h6>
                  <p className="mb-3 text-muted">
                    Get lightning-fast execution, real-time insights, and full portfolio control — all in one platform.
                  </p>

                  <Link href={`${DEFAULT_PAGE_PREFIX}auth/register`} className="btn btn-dark mb-0 mt-2">
                    Explore the Markets
                  </Link>
                </Card>
