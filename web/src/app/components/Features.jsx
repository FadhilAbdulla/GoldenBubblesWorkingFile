...
const Features = () => {
  return (
    <section className="bg-dark position-relative overflow-hidden pt-md-6" data-bs-theme="dark">
      ...
      <Container className="position-relative">
        <div className="inner-container-small text-center mb-4 mb-sm-5">
          <span className="text-primary fw-bold text-uppercase">Products</span>
          <h2 className="mb-0 mt-4">Trade the Market’s Leading Products</h2>
          <p className="text-white-50 mt-2">
            Explore a wide selection of trading products carefully tailored for every type of investor. Whether you’re a beginner or an experienced
            trader, pick your preferred market and trade with confidence, backed by our reliable tools and insights.
          </p>
        </div>

        <TabContainer defaultActiveKey="forex">
          <Row>
            <Col lg={10} xl={8} xxl={6} className="mx-auto mb-4 mb-xl-6">
              <div className="bg-light rounded-pill p-2">
                <Nav variant="pills" className="nav-pills-primary nav-responsive justify-content-between">
                  <NavItem>
                    <NavLink eventKey="forex" className="nav-link rounded-pill">
                      <BsCurrencyExchange className="me-2" />
                      Forex
                    </NavLink>
                  </NavItem>

                  <NavItem>
                    <NavLink eventKey="metals" className="rounded-pill">
                  ...
                  <NavItem className="position-relative">
                    <NavLink eventKey="shares" className="rounded-pill">
                  ...
                  <NavItem>
                    <NavLink eventKey="indices" className="rounded-pill">
                  ...
                  <NavItem>
                    <NavLink eventKey="commodities" className="rounded-pill">
            ...
            <Col xs={11} lg={12} className="w-100">
              <TabContent>
                {['forex', 'metals', 'shares', 'indices', 'commodities'].map((productKey) => (
