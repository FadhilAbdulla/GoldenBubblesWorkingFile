        ...
        <Row className="justify-content-between">
          <Col lg={6} className="mb-6 mb-lg-0 =">
            <div className="d-flex flex-column h-100 justify-content-center">
              ...
              <p className="mb-4">
                Our team is here to help you succeed. Reach out anytime at{' '}
                <Link href="mailto:support@goldenbubbles.com">support@goldenbubbles.com</Link> or use the form to get a quick response from our
                experts.
              </p>
