        ...
        <Col sm={10} lg={5} className="d-flex m-auto vh-100">
          <Row className="w-100 m-auto">
            <Col sm={10} className="my-5 m-auto">
              <PageHeading heading="Start Trading Today !" subHeading="Open your account and access global markets with confidence" />
              ...
              <div className="mt-4 text-center">
                <span>
                  Already have an account?<Link href={`${DEFAULT_PAGE_PREFIX}auth/login`}> Sign in here</Link>
                </span>
              </div>
            </Col>
          </Row>
