        ...
        <Col sm={10} lg={5} className="d-flex m-auto vh-100">
          <Row className="w-100 m-auto">
            <Col sm={10} className="my-5 m-auto">
              <PageHeading heading="Welcome Back !" subHeading="Sign in to access your trading account" />
              {/* <ThirdPartyAuth /> */}
              ...
              <Form onSubmit={login} className="mt-4">
                ...
                <div className="mb-4 d-flex justify-content-between">
                  ...
                  {/* <Link href={`${DEFAULT_PAGE_PREFIX}auth/forgot`} className="link-underline-primary">
                    Forgot password?
                  </Link> */}
                </div>
              ...
              <div className="mt-4 text-center">
                <span>
                  Not registered yet?<Link href={`${DEFAULT_PAGE_PREFIX}auth/register`}> Create an account</Link>
                </span>
              </div>
            </Col>
          </Row>
