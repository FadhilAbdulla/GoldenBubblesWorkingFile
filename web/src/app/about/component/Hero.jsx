...
import decorationPattern from '@/assets/images/elements/decoration-pattern-1-gold.svg'
    ...
    <section className="position-relative overflow-hidden pb-0 pt-xl-9">
      ...
      <Container className="pt-4 pt-sm-5">
        <Row className="g-xl-5">
          <Col xl={7} className="mb-5 mb-xl-0 mt-0">
            <div className="pe-xxl-4">
              ...
              <h1 className="mt-3 lh-base">
                ...
                <span className="cd-headline clip big-clip is-full-width text-primary mb-0 d-block d-xxl-inline-block">
                  <ReactTyped
                    strings={['Financial Growth.', 'Global Reach.', 'Wealth Building.', 'Smart Trading.', 'Profit Opportunities.']}
                    className="typed"
                    typeSpeed={100}
                    backSpeed={30}
                    loop
              ...
              <p className="mb-0 mt-4 mt-md-5">
                From strategy to execution, we deliver trading solutions that drive results. Let your investments grow with our innovative and
                powerful platform.
              </p>
            </div>
          </Col>

          <Col md={10} xl={5} className="position-relative mx-auto  mt-xl-0">
