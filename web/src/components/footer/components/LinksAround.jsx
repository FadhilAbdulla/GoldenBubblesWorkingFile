    ...
    <Row className="g-4 justify-content-between">
      <Col lg={5}>
        ...
        <p className="mt-4 mb-2">
          ...
          {/* Empowering traders with smart tools, real-time insights, and access to global markets. */}
          We are a team committed to enhance every trader’s experience, providing innovative tools, valuable insights, and dependable support for
          confident trading.
        </p>
