...
const GetStartedJourney = () => {
  return (
    <Row className="g-3 g-md-4 align-items-center">
      <Col md={8}>
        <h3 className="mb-0 lh-base">
          Your journey to master{' '}
          <span className="position-relative z-index-1" style={{ display: 'inline-block' }}>
            <span style={{ position: 'relative', zIndex: 1 }}>trading</span>
            <span className="position-absolute top-50 start-50 translate-middle z-index-n1 ms-n2 d-none d-lg-block" style={{ pointerEvents: 'none' }}>
      ...
      <Col md={4} className="text-md-end ms-auto">
        <Link className="btn btn-lg btn-primary-soft icon-link icon-link-hover mb-0" href={`${DEFAULT_PAGE_PREFIX}auth/register`}>
          Start Your Journey
